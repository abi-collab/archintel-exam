  ...
  <div class="max-w-5xl mx-auto p-24">
    <div class="flex justify-between">
      ...
      <button class="border rounded py-2 px-4 text-sm bg-blue-500 text-white"
        @click="companyStore.isShowAddCompanyModal = true">Add Company</button>
    </div>
    <ul role="list" class="divide-y divide-gray-100 space-y-2 mt-4">
      <li v-for="comp in companyStore.allCompanies" :key="comp.id"
        ...
        <button class="hidden group-hover:block p-3 capitalize text-gray-400 border hover:bg-gray-200">Edit</button>
      </li>
    </ul>
  </div>
</template>
