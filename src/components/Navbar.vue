            ...
            <transition enter-active-class="transition ease-out duration-200"
              ...
              <MenuItems
                ...
                <MenuItem as="div" v-slot="{ active }"
                  :class="[active ? 'bg-gray-100 outline-none' : '', 'block px-4 py-2 text-sm text-gray-700 w-full text-left']">
                <p class="block px-4 py-2 text-sm text-gray-700 font-bold">User Type</p>
                </MenuItem>
                <MenuItem as="div">
